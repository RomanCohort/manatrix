"""
Enhanced REPL (Read-Eval-Print Loop) for Manatrix CLI.
...
class EnhancedREPL:
    ...
    def _completer(self, text: str, state: int) -> Optional[str]:
        ...
        print(f"[ERROR] readline failed: {e}")
        line = text
    ...
    def _complete_path(self, text: str) -> List[str]:
        ...
        print(f"[ERROR] path completion: {e}")
    ...
    def _print_banner(self):
        """Print welcome ASCII art banner."""
        banner = r"""
  ____             ____ _                ____                          _
...
"""
        banner += """
  +-----------------------------------------------------+
  |  Manatrix Interactive Shell  v2.0                |
  |  Type 'help' for commands, 'exit' to quit           |
  |  Tab completion enabled, history: ~/.pg_history     |
  +-----------------------------------------------------+
"""
        print(banner)
...
""")
    ...
    def _cmd_run(self, args: List[str]):
        ...
        import subprocess
        cmd = [sys.executable, "manatrix/cli.py"] + args
    ...
    def _cmd_eval(self, args: List[str]):
        ...
        from manatrix.cli import _evaluate_password_cli
    ...
    def _cmd_hash(self, args: List[str]):
        ...
        from manatrix.cli import _print_hashes
        _print_hashes(text)
    ...
    def _cmd_encode(self, args: List[str]):
        ...
        from manatrix.cli import _encode_text
    ...
    def _cmd_decode(self, args: List[str]):
        ...
        from manatrix.cli import _decode_text
    ...
    def _search_documentation(self, term: str):
        ...
        found = []
        search_paths = [
            Path(__file__).parent,  # manatrix package
        ]
    ...
    def _cmd_external(self, cmd: str, args: List[str]):
        ...
        import subprocess
        full_cmd = [sys.executable, "manatrix/cli.py", cmd] + args
